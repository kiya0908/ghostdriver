...
export const Route = createFileRoute('/cars/limited')({
  loader: () => getVehicles({ data: 'limited' }),
  head: () => createSeo('Ghost Driver Limited Cars – Showroom & Limited Vehicle List', 'Track Ghost Driver limited cars, recent showroom vehicles and last-checked availability evidence without treating old rotations as current stock.', '/cars/limited'),
