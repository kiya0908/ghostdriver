...
export const Route = createFileRoute('/vehicles/free')({
  ...
  head: () => createSeo('Ghost Driver Free Cars – Starter & Free Vehicle Guide', 'Find Ghost Driver free cars, starter vehicles and reported group rewards, with unlock-method verification notes and current data-quality labels.', '/vehicles/free'),
