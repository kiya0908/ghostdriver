...
const questions = [
  ...
  ['Why are some car stats not shown?', 'The game is in Pre-Alpha and reliable values are not always available. We would rather omit an unknown value than publish a fabricated number.'],
...
export const Route = createFileRoute('/faq')({ head: () => createSeo('Ghost Driver FAQ', 'Answers about Ghost Driver codes, car data, this unofficial fan wiki and community corrections.', '/faq'), component: FaqPage })
