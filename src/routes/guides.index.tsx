...
function GuidesPage() {
  ...
  return (
    <div className="container page-shell">
      ...
      <section className="section">
        <div className="section-heading"><div><div className="section-title-row"><span className="section-index">02</span><h2>How to Use These Ghost Driver Guides</h2></div></div></div>
      ...
      <section className="section">
        <div className="section-heading"><div><div className="section-title-row"><span className="section-index">03</span><h2>Start With the Beginner Guide</h2></div></div></div>
      ...
      <section className="section">
        <div className="section-heading"><div><div className="section-title-row"><span className="section-index">04</span><h2>Progress With Money and Tuning Guides</h2></div></div></div>
      ...
      <section className="section">
        <div className="section-heading"><div><div className="section-title-row"><span className="section-index">05</span><h2>Improve Traffic Cutting</h2></div></div></div>
        <div className="section-copy">
      ...
      <section className="section">
        <div className="section-heading"><div><div className="section-title-row"><span className="section-index">06</span><h2>Check Song IDs Carefully</h2></div></div></div>
        <div className="section-copy">
