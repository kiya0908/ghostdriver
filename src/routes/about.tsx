...
function AboutPage() {
  return <InfoPage eyebrow="Project identity" title="Built by Players, Not the Developers" description="Ghost Driver Wiki is an independent field manual designed to make changing Pre-Alpha information easier to verify and use." showNotice={false}>
    <section><h2>Our purpose</h2><p>We organize the questions players ask most: which codes work, what is known about each car, how to begin, and what changed. The site is built for fast lookup on mobile and for search engines to read without client-side JavaScript.</p></section>
